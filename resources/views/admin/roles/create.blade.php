    ...
    <div class="admin-form-card">
        ...
        <form action="{{ route('admin.roles.store') }}" method="POST" class="admin-form">
            ...
            <div class="admin-form-grid">
                ...
                <div class="admin-form-group admin-form-group-full">
                    ...
                    <div class="permission-grid">
                        <label class="permission-card" data-permission="can_manage_books">
                            <input type="checkbox" name="can_manage_books" value="1" {{ old('can_manage_books') ? 'checked' : '' }}>
                        ...
                        <label class="permission-card" data-permission="can_manage_orders">
                            <input type="checkbox" name="can_manage_orders" value="1" {{ old('can_manage_orders') ? 'checked' : '' }}>
                            <div class="permission-card-content">
                        ...
                        <label class="permission-card" data-permission="can_manage_users">
                        ...
                        <label class="permission-card" data-permission="can_view_reports">
                            <input type="checkbox" name="can_view_reports" value="1" {{ old('can_view_reports') ? 'checked' : '' }}>
                            <div class="permission-card-content">
            ...
            <div class="admin-form-actions">
                <button type="submit" class="admin-btn admin-btn-primary"><i class="fas fa-check"></i> Save Role</button>
